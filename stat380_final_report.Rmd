...
accuracy of 96.9%. While these numbers look incredible on paper, the
...
what happened in real life: Houston, Florida, Duke, and Auburn.
However, my model was correct and much more confident in its top pick, giving
Florida a 72% probability and Houston came in second with a 66% probability of 
making the Final Four compared to the Random Forest's 56%. Just like Jackson's model, mine struggled with upsets, as Missouri and St. John's were included in this model as well despite losing in the first two rounds. My model also identified new potential
...
**\underline{Sections}**:\newline
\newline
- SVM, XGBoost, & Results: Polished with Gemini\newline
- Data Analysis: Polished with Perplexity